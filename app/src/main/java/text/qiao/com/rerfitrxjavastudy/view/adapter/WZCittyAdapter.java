...
public class WZCittyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private List<String> mWZCity;
    ...
    public WZCittyAdapter(Context mContext, List<String> mWZCity) {
        this.mContext = mContext;
        this.mWZCity = mWZCity;
    }

    public void setLeiBiebeanList(List<String> mWZCity) {
        this.mWZCity = mWZCity;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ItemViewHolder) {
            ItemViewHolder itemViewHolder = (ItemViewHolder) holder;
                    ...
                    if (mWZCity.get(position) != null) {
                        itemViewHolder.setData(mWZCity.get(position));
                    }
    ...
    public int getItemCount() {
        if (mWZCity != null&&mWZCity.size()>0) {
            return mWZCity.size();
        }
        return 0;
    }
